...
\title[Whole-cromosome pairwise alignment]{Whole-chromosome pairwise alignment using the hierarchical wavefront algorithm}
...
The time and memory required to compute the pairwise alignments increase quadratically with the sequence length.
