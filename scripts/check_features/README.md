...
bash $DIR_WF_PAPER/scripts/check_features/feature_checker.sh scerevisiae7.paf $DIR_WF_PAPER/busco/scerevisiae/S288C/saccharomycetes_odb10/S288C.busco-genes.bed /scratch
